                ...
                <div class="row justify-content-end  align-items-center ">
                    <div class="col-md-2">
                        <div class="btn btn-warning btn-sm d-flex justify-content-between" @click="downloadExcel()"> 
                            <h6 class="m-0"><b>Excel გადმოწერა</b></h6>
                            <img src="../../assets/img/icon/download-solid.svg" alt="download excel">
                        </div><br>
                        <div class="btn btn-warning btn-sm d-flex justify-content-between" @click="downloadPdf()"> 
                            <h6 class="m-0"><b>PDF გადმოწერა</b></h6>
                            <img src="../../assets/img/icon/download-solid.svg" alt="download excel">
                        </div>
                    </div>
                </div>
...
<script>
  ...
  export default {
    ...
    methods : {
        ...
        downloadPdf() {
            window.open("https://survey.rda.gov.ge/api/exhibition/download/pdf/" + this.new_value);
        },
